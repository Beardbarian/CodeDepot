...
$ONEDRIVESYNC = "$env:OneDrive"

# Copy Folder Contents
$userpath=$env:USERPROFILE
Copy-Item -Path "$userpath\Desktop" "$env:OneDrive" -recurse -force
Copy-Item -Path "$userpath\Documents" "$env:OneDrive" -recurse -force
Copy-Item -Path "$userpath\Pictures" "$env:OneDrive" -recurse -force
